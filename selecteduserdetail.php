...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark py-4">
  <div class="container-fluid">
    ...
    <title>TRANSFER MONEY EASILY</title>
...
<body style="background-image : url(images/1.jpg)">
	...
	<div class="container">
        <h2 class="text-center pt-4" style="color : #ffcccc;">Easy Money Transfer</h2>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
        ...
        <br><br><br>
        <label style="color : #ffcccc;"><b>Transfer To:</b></label>
        ...
        <br>
        <br>
            <label style="color : #ffcccc;"><b>Amount:</b></label>
