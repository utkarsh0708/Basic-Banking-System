...
<div class="container">
        <h2 class="text-center pt-4" style="color : #ffcccc;">Our Customers</h2>
        <br>
            <div class="row">
                <div class="col">
                    <div class="table-responsive-sm">
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered" style="border-color:#ffcccc;">
                        <thead style="color : #ffcccc;">
                            <tr>
         ...
         <footer class="text-center mt-5 py-2">
            <p style="color : #ffcccc">&copy 2021 <b>Utkarsh Bhosekar</b> <br>EVERYBODY'S BANK</p>
        </footer>
